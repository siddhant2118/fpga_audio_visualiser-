...
module top_adhavan #(
    ...
    input  wire        frame_done,      // from siddhant
    input  wire [11:0] m2_rd_data,      
    output reg  [7:0]  m2_rd_addr,      // address to siddhant bram
...
xfft_0 forward_fft (
    ...
    .aclken                 (1'b1),         
    .aresetn                (~reset),
    .s_axis_config_tdata    (8'b00000001),  // forward = 1
...
xfft_1 inverse_fft (
    ...
    .aclken                 (1'b1),         
    .aresetn                (~reset),
    .s_axis_config_tdata    (8'b00000000),  // inverse = 0
    .s_axis_config_tvalid   (1'b1),
    .s_axis_config_tready   (),
